...
Si bien existen **6 tipos de joins básicos**, nos concentraremos acá los **2 que más se utilizan**.
...
2- Generar una base de datos, a partir *artist* y *bands*, que contenga las variables *fisrt* (nombre), *last* (apellido), la banda (*band*) e instrumento (*instrument*), que incluya solo a los artistas que tienen información en las 4 variables.
...
# seleccionamos día, mes, año de nacimiento y creaoms una fecha
nac2017 %>% 
...
En el archivo "nacimientos.rar" que se encuentra disponible en la carpeta **'data/tarea' en la sesion 3 de nuestro canal en Teams (Generación I)**, encontrarán las siguientes bases de datos:
...
1- En primer lugar, **cargue estos 3 objetos en su entorno y explórelos**. .pur[¿Qué son y cómo se relacionan estos objetos?]
